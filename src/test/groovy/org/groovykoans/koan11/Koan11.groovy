 ...
 *
 * Reading list:
 *   * http://www.groovy-lang.org/Database+features
 *   * http://www.groovy-lang.org/api/groovy/sql/DataSet.html
 *
 */
class Koan11 extends GroovyTestCase {
    ...
    void test01_CreateDb() {
        ...
        // You can find some info here: http://www.groovy-lang.org/Database+features
    ...
    void test02_MoreOnInsertingData() {
        ...
        Sql.withInstance('jdbc:h2:mem:groovyDb2', 'sa', '', 'org.h2.Driver') { db ->
            ...
            // db.dataSet('PERSON') method. See http://www.groovy-lang.org/api/groovy/sql/DataSet.html
