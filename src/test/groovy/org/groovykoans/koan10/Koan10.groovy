 ...
 *
 * Reading list:
 *  * http://www.groovy-lang.org/Reading+XML+using+Groovy's+XmlSlurper
 *  * http://www.groovy-lang.org/api/groovy/util/XmlSlurper.html
 *  * http://www.groovy-lang.org/groovy-jdk/java/util/Collection.html#sort(groovy.lang.Closure)
 *  * http://mrhaki.blogspot.com/2009/08/groovy-goodness-spaceship-operator.html
 *  * http://www.groovy-lang.org/Creating+XML+using+Groovy's+MarkupBuilder
 *  * http://www.groovy-lang.org/api/groovy/xml/MarkupBuilder.html
 ...
 *  * http://www.groovy-lang.org/Using+Ant+from+Groovy
...
class Koan10 extends GroovyTestCase {
    ...
    void test01_XmlSlurpersReader() {
        ...
        // Using the reference at http://www.groovy-lang.org/Reading+XML+using+Groovy's+XmlSlurper and
        // http://www.groovy-lang.org/api/groovy/util/XmlSlurper.html, read the content of movies.xml
    ...
    void test03_XmlMarkupBuilder1() {
        ...
        // Read here: http://www.groovy-lang.org/Creating+XML+using+Groovy's+MarkupBuilder
        // And here: http://www.groovy-lang.org/api/groovy/xml/MarkupBuilder.html
    ...
    void test05_AntBuilderCopy() {
        ...
        // So how does Groovy support Ant? With AntBuilder: http://www.groovy-lang.org/Using+Ant+from+Groovy
